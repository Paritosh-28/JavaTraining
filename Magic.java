...
class Mentalist implements Magician
  {
    public Magic doTrick(Account accRef) {
		System.out.println(" playing mind gaames...");
		Magic magic = new Mentalism();
...
class Mentalism implements Magic
  {
    public void show()
    {
      System.out.println("Reading else's mind and telling what they are thinking....");
	}
}
